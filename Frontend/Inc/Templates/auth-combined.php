	...
	<div class="questionhub-card questionhub-auth-combined">
		...
		<div class="questionhub-auth-tab-content" id="questionhub-tab-register" style="display:none;">
			...
			<form id="questionhub-register-form" class="questionhub-form" novalidate>
				...
				<div class="questionhub-form-group">
					<label for="qh-reg-email"><?php esc_html_e( 'Email', 'questionhub' ); ?> <?php echo $email_required ? '<span class="required">*</span>' : '<span class="questionhub-optional">(' . esc_html__( 'optional', 'questionhub' ) . ')</span>'; ?></label>
					<input type="email" id="qh-reg-email" name="email" class="questionhub-input" placeholder="<?php esc_attr_e( 'you@example.com', 'questionhub' ); ?>" <?php echo $email_required ? 'required' : ''; ?>>
				</div>
				<div class="questionhub-form-group">
